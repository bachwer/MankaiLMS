document.addEventListener("DOMContentLoaded", function () {
  ...
  function renderContent() {
    ...
    description1.innerHTML = textContent.description;
    target.innerHTML = textContent.targetLesson
    title.innerHTML = textContent.title;
    contentMain.innerHTML = textContent.lessonContent
    description.innerHTML = textContent.description;
